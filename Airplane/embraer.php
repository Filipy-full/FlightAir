...
// Obtener todos los modelos de aviones Embraer (fab_id = 3)
...
<body>
    <main>
        <h1 class="title-modelos" id="titulo-embraer">Modelos de Aviones Embraer</h1>
        <div class="container" id="container-modelos-Embraer">
            <?php
